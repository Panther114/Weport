...
$webotRunsPng = Join-Path $OutputDir 'webot-runs.png'
$mentionPickerPng = Join-Path $OutputDir 'mention-picker.png'
...
Assert-Captured $webotRunsPng 'webot-runs.png'
Assert-Captured $mentionPickerPng 'mention-picker.png'
...
Assert-ImageHasContent $webotRunsPng 'WeBot run log'
Assert-ImageHasContent $mentionPickerPng 'mention picker'
